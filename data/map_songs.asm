MapSongBanks:
	...
	db MUSIC_DUNGEON3, 0 ; DIGLETTS_CAVE_ROUTE_2
	db MUSIC_ROUTES2, 0 ; VIRIDIAN_FOREST_NORTH_GATE
	db MUSIC_CITIES1, 0 ; ROUTE_2_TRADE_HOUSE
	db MUSIC_ROUTES2, 0 ; ROUTE_2_GATE
	db MUSIC_ROUTES2, 0 ; VIRIDIAN_FOREST_SOUTH_GATE
	db MUSIC_ROUTES2, 0 ; VIRIDIAN_FOREST
	...
	db MUSIC_CITIES1, 0 ; CERULEAN_TRASHED_HOUSE
	db MUSIC_CITIES1, 0 ; CERULEAN_TRADE_HOUSE
	db MUSIC_POKECENTER, 0 ; CERULEAN_POKECENTER
	db MUSIC_GYM, 0 ; CERULEAN_GYM
	db MUSIC_CITIES1, 0 ; BIKE_SHOP
	...
	db MUSIC_ROUTES3, 0 ; UNDERGROUND_PATH_ROUTE_5
	db MUSIC_CITIES1, 0 ; DAYCARE
	db MUSIC_ROUTES3, 0 ; ROUTE_6_GATE
	db MUSIC_ROUTES3, 0 ; UNDERGROUND_PATH_ROUTE_6
	db MUSIC_VERMILION, 0 ; UNDERGROUND_PATH_ROUTE_6_COPY
	db MUSIC_ROUTES3, 0 ; ROUTE_7_GATE
	db MUSIC_ROUTES3, 0 ; UNDERGROUND_PATH_ROUTE_7
	db MUSIC_CELADON, 0 ; UNDERGROUND_PATH_ROUTE_7_COPY
	db MUSIC_ROUTES3, 0 ; ROUTE_8_GATE
	db MUSIC_ROUTES3, 0 ; UNDERGROUND_PATH_ROUTE_8
	db MUSIC_POKECENTER, 0 ; ROCK_TUNNEL_POKECENTER
	db MUSIC_DUNGEON3, 0 ; ROCK_TUNNEL_1F
	db MUSIC_DUNGEON1, 0 ; POWER_PLANT
	db MUSIC_ROUTES4, 0 ; ROUTE_11_GATE_1F
	db MUSIC_DUNGEON3, 0 ; DIGLETTS_CAVE_ROUTE_11
	db MUSIC_ROUTES4, 0 ; ROUTE_11_GATE_2F
	db MUSIC_ROUTES4, 0 ; ROUTE_12_GATE_1F
	db MUSIC_CITIES1, 0 ; BILLS_HOUSE
	...
	db MUSIC_DUNGEON3, 0 ; UNDERGROUND_PATH_NORTH_SOUTH
	db MUSIC_INDIGO_PLATEAU, 0 ; CHAMPIONS_ROOM
	db MUSIC_DUNGEON3, 0 ; UNDERGROUND_PATH_WEST_EAST
	...
	db MUSIC_CELADON, 0 ; FUCHSIA_BILLS_GRANDPAS_HOUSE
	db MUSIC_POKECENTER, 0 ; FUCHSIA_POKECENTER
	db MUSIC_CELADON, 0 ; WARDENS_HOUSE
	db MUSIC_CELADON, 0 ; SAFARI_ZONE_GATE
	db MUSIC_GYM, 0 ; FUCHSIA_GYM
	db MUSIC_CELADON, 0 ; FUCHSIA_MEETING_ROOM
	...
	db MUSIC_CELADON, 0 ; FUCHSIA_GOOD_ROD_HOUSE
	...
	db MUSIC_ROUTES4, 0 ; ROUTE_15_GATE_1F
	db MUSIC_ROUTES4, 0 ; ROUTE_15_GATE_2F
	db MUSIC_ROUTES3, 0 ; ROUTE_16_GATE_1F
	db MUSIC_ROUTES3, 0 ; ROUTE_16_GATE_2F
	db MUSIC_CELADON, 0 ; ROUTE_16_FLY_HOUSE
	db MUSIC_CITIES1, 0 ; ROUTE_12_SUPER_ROD_HOUSE
	db MUSIC_ROUTES3, 0 ; ROUTE_18_GATE_1F
	db MUSIC_ROUTES3, 0 ; ROUTE_18_GATE_2F
	...
	db MUSIC_DUNGEON3, 0 ; DIGLETTS_CAVE
